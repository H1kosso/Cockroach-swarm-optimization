...
private:
    ...
    std::vector<double> findGlobalOptimum(std::vector<std::vector<double>> cockroaches, double (*testFunction)(std::vector<double>, int));
    std::vector<double> updatePosition(std::vector<double> position, std::vector<double> optimumPosition, double stepSize);
